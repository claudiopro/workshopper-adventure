...
class Adventure extends EventEmitter {
  ...
  add(name_or_object, fn_or_object, fn) {
    var meta
      , dir
      , stat
  ...
  end(mode, pass, exercise, callback) {
  ...
  runExercise(exercise, mode, args) {
